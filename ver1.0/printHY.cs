...
namespace ver1._0
{
    public partial class printHY : Form
    {
        ...
        public printHY(string danhao, string paname, string sex, string age, string classname, string zhenduan, string regid, string mudi, string cardnum, string pay, string date, string order, string yishi)
        {
            InitializeComponent();
